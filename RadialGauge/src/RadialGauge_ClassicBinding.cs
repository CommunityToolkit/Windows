...
public partial class RadialGauge_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="RadialGauge_ClassicBinding"/> class.
    /// </summary>
    public RadialGauge_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(RadialGauge_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(RadialGauge_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(RadialGauge_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((RadialGauge_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
