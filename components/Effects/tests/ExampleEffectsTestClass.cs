...
[TestClass]
public partial class ExampleEffectsTestClass : VisualUITestBase
{
    ...
    [UIThreadTestMethod]
    public void SimpleUIExamplePageTest(ExampleEffectsTestPage page)
    {
        // You can use the Toolkit Visual Tree helpers here to find the component by type or name:
        var component = page.FindDescendant<Effects_ClassicBinding>();

        Assert.IsNotNull(component);

        var componentByName = page.FindDescendant("EffectsControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleEffectsTestPage page)
    {
    ...
    public async Task ComplexAsyncUIExampleTest()
    {
        await EnqueueAsync(() =>
        {
            var component = new Effects_ClassicBinding();
            Assert.IsNotNull(component);
        });
    }
