...
[ToolkitSample(id: nameof(EffectsTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class EffectsTemplatedSample : Page
{
    public EffectsTemplatedSample()
    {
