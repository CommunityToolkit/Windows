...
/// You can choose to start here or from the <see cref="Triggers_ClassicBinding"/> or <see cref="Triggers_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class Triggers : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(Triggers), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is Triggers panel)
        {
