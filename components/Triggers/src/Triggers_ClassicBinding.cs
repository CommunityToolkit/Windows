...
public partial class Triggers_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Triggers_ClassicBinding"/> class.
    /// </summary>
    public Triggers_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(Triggers_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(Triggers_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Triggers_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Triggers_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
