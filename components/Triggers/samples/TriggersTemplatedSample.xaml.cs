...
[ToolkitSample(id: nameof(TriggersTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class TriggersTemplatedSample : Page
{
    public TriggersTemplatedSample()
    {
