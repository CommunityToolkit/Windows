...
[TestClass]
public partial class ExampleRangeSelectorTestClass : VisualUITestBase
{
    // If you don't need access to UI objects directly or async code, use this pattern.
    [TestMethod]
    public void SimpleSynchronousExampleTest()
    {
        var assembly = typeof(RangeSelector).Assembly;
        var type = assembly.GetType(typeof(RangeSelector).FullName ?? string.Empty);

        Assert.IsNotNull(type, "Could not find RangeSelector type.");
        Assert.AreEqual(typeof(RangeSelector), type, "Type of RangeSelector does not match expected type.");
    }
    ...
    public void SimpleUIExamplePageTest(ExampleRangeSelectorTestPage page)
    {
        ...
        var componentByName = page.FindDescendant("RangeSelectorControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleRangeSelectorTestPage page)
    {
