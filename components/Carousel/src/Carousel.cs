...
/// You can choose to start here or from the <see cref="Carousel_ClassicBinding"/> or <see cref="Carousel_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class Carousel : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(Carousel), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is Carousel panel)
        {
