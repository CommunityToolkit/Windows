...
/// </summary>
public partial class Carousel_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Carousel_xBind"/> class.
    /// </summary>
    public Carousel_xBind()
    {
        this.DefaultStyleKey = typeof(Carousel_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Carousel_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Carousel_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
