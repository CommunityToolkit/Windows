...
[TestClass]
public partial class ExampleRichSuggestBoxTestClass : VisualUITestBase
{
    // If you don't need access to UI objects directly or async code, use this pattern.
    [TestMethod]
    public void SimpleSynchronousExampleTest()
    {
        var assembly = typeof(RichSuggestBox).Assembly;
        var type = assembly.GetType(typeof(RichSuggestBox).FullName ?? string.Empty);

        Assert.IsNotNull(type, "Could not find RichSuggestBox type.");
        Assert.AreEqual(typeof(RichSuggestBox), type, "Type of RichSuggestBox does not match expected type.");
    }
    ...
    {
        var component = new RichSuggestBox();
    ...
    [UIThreadTestMethod]
    public void SimpleUIExamplePageTest(ExampleRichSuggestBoxTestPage page)
    {
        // You can use the Toolkit Visual Tree helpers here to find the component by type or name:
        var component = page.FindDescendant<RichSuggestBox_ClassicBinding>();

        Assert.IsNotNull(component);

        var componentByName = page.FindDescendant("RichSuggestBoxControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleRichSuggestBoxTestPage page)
    {
    ...
    public async Task ComplexAsyncUIExampleTest()
    {
        await EnqueueAsync(() =>
        {
            var component = new RichSuggestBox_ClassicBinding();
            Assert.IsNotNull(component);
        });
    }
