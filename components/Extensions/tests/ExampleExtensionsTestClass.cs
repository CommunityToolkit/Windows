...
[TestClass]
public partial class ExampleExtensionsTestClass : VisualUITestBase
{
    ...
    public void SimpleSynchronousExampleTest()
    {
        ...
        var type = assembly.GetType(typeof(Extensions).FullName ?? string.Empty);

        Assert.IsNotNull(type, "Could not find Extensions type.");
        Assert.AreEqual(typeof(Extensions), type, "Type of Extensions does not match expected type.");
    }
    ...
    [UIThreadTestMethod]
    public void SimpleUIExamplePageTest(ExampleExtensionsTestPage page)
    {
        // You can use the Toolkit Visual Tree helpers here to find the component by type or name:
        var component = page.FindDescendant<Extensions_ClassicBinding>();

        Assert.IsNotNull(component);

        var componentByName = page.FindDescendant("ExtensionsControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleExtensionsTestPage page)
    {
    ...
    public async Task ComplexAsyncUIExampleTest()
    {
        await EnqueueAsync(() =>
        {
            var component = new Extensions_ClassicBinding();
            Assert.IsNotNull(component);
        });
    }
