...
[ToolkitSample(id: nameof(HelpersCustomSample), "Custom control", description: $"A sample for showing how to create and use a {nameof(Helpers)} custom control.")]
public sealed partial class HelpersCustomSample : Page
{
    public HelpersCustomSample()
    {
