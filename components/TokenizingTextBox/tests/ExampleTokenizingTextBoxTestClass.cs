...
[TestClass]
public partial class ExampleTokenizingTextBoxTestClass : VisualUITestBase
{
    // If you don't need access to UI objects directly or async code, use this pattern.
    [TestMethod]
    public void SimpleSynchronousExampleTest()
    {
        var assembly = typeof(TokenizingTextBox).Assembly;
        var type = assembly.GetType(typeof(TokenizingTextBox).FullName ?? string.Empty);

        Assert.IsNotNull(type, "Could not find TokenizingTextBox type.");
        Assert.AreEqual(typeof(TokenizingTextBox), type, "Type of TokenizingTextBox does not match expected type.");
    }
    ...
    public void SimpleUIExamplePageTest(ExampleTokenizingTextBoxTestPage page)
    {
        ...
        var componentByName = page.FindDescendant("TokenizingTextBoxControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleTokenizingTextBoxTestPage page)
    {
