...
[ToolkitSample(id: nameof(BladeViewTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class BladeViewTemplatedSample : Page
{
    public BladeViewTemplatedSample()
    {
