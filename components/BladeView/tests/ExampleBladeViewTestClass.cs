...
namespace BladeViewTests;

[TestClass]
public partial class ExampleBladeViewTestClass : VisualUITestBase
{
    // If you don't need access to UI objects directly or async code, use this pattern.
    [TestMethod]
    public void SimpleSynchronousExampleTest()
    {
        var assembly = typeof(BladeView).Assembly;
        var type = assembly.GetType(typeof(BladeView).FullName ?? string.Empty);

        Assert.IsNotNull(type, "Could not find BladeView type.");
        Assert.AreEqual(typeof(BladeView), type, "Type of BladeView does not match expected type.");
    }
    ...
    [UIThreadTestMethod]
    public void SimpleUIExamplePageTest(ExampleBladeViewTestPage page)
    {
        // You can use the Toolkit Visual Tree helpers here to find the component by type or name:
        var component = page.FindDescendant<BladeView_ClassicBinding>();

        Assert.IsNotNull(component);

        var componentByName = page.FindDescendant("BladeViewControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleBladeViewTestPage page)
    {
    ...
    public async Task ComplexAsyncUIExampleTest()
    {
        await EnqueueAsync(() =>
        {
            var component = new BladeView_ClassicBinding();
            Assert.IsNotNull(component);
        });
    }
