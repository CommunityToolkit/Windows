...
/// You can choose to start here or from the <see cref="BladeView_ClassicBinding"/> or <see cref="BladeView_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class BladeView : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(BladeView), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is BladeView panel)
        {
