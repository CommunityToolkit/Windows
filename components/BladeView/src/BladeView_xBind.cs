...
/// </summary>
public partial class BladeView_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="BladeView_xBind"/> class.
    /// </summary>
    public BladeView_xBind()
    {
        this.DefaultStyleKey = typeof(BladeView_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(BladeView_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((BladeView_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
