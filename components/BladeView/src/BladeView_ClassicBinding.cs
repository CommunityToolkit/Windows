...
public partial class BladeView_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="BladeView_ClassicBinding"/> class.
    /// </summary>
    public BladeView_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(BladeView_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(BladeView_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(BladeView_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((BladeView_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
