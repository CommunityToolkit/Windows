...
[ToolkitSample(id: nameof(PrimitivesTemplatedStyleCustomSample), "Templated control (restyled)", description: "A sample for showing how to create a use and templated control with a custom style.")]
public sealed partial class PrimitivesTemplatedStyleCustomSample : Page
{
    public PrimitivesTemplatedStyleCustomSample()
    {
