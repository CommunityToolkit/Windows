...
[ToolkitSample(id: nameof(PrimitivesTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class PrimitivesTemplatedSample : Page
{
    public PrimitivesTemplatedSample()
    {
