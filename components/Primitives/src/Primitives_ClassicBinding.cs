...
public partial class Primitives_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Primitives_ClassicBinding"/> class.
    /// </summary>
    public Primitives_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(Primitives_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(Primitives_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Primitives_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Primitives_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
