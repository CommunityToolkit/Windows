...
/// </summary>
public partial class Primitives_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Primitives_xBind"/> class.
    /// </summary>
    public Primitives_xBind()
    {
        this.DefaultStyleKey = typeof(Primitives_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Primitives_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Primitives_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
