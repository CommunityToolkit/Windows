...
[ToolkitSample(id: nameof(ColorPickerCustomSample), "Custom control", description: $"A sample for showing how to create and use a {nameof(CommunityToolkit.WinUI.Controls.ColorPicker)} custom control.")]
public sealed partial class ColorPickerCustomSample : Page
{
    public ColorPickerCustomSample()
    {
