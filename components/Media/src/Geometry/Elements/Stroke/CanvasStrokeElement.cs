...
using CommunityToolkit.WinUI.Media.Geometry.Elements.Brush;
using CommunityToolkit.WinUI.Media.Geometry.Parsers;

namespace CommunityToolkit.WinUI.Media.Geometry.Elements.Stroke;
...
internal sealed class CanvasStrokeElement : AbstractCanvasStrokeElement
{
    ...
    {
        default(ArgumentNullException).ThrowIfNull(_brush);
        default(ArgumentNullException).ThrowIfNull(_style);
