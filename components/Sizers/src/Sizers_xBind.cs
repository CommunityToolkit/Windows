...
/// </summary>
public partial class Sizers_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Sizers_xBind"/> class.
    /// </summary>
    public Sizers_xBind()
    {
        this.DefaultStyleKey = typeof(Sizers_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Sizers_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Sizers_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
