...
public partial class Sizers_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="Sizers_ClassicBinding"/> class.
    /// </summary>
    public Sizers_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(Sizers_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(Sizers_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((Sizers_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
