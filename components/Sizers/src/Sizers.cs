...
/// You can choose to start here or from the <see cref="Sizers_ClassicBinding"/> or <see cref="Sizers_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class Sizers : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(Sizers), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is Sizers panel)
        {
