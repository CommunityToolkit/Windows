...
[ToolkitSample(id: nameof(RadialGaugeXbindBackedSample), "Backed templated control", description: "A sample for showing how to create and use a templated control with a backed resource dictionary.")]
public sealed partial class RadialGaugeXbindBackedSample : Page
{
    public RadialGaugeXbindBackedSample()
    {
