...
[ToolkitSample(id: nameof(RadialGaugeTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class RadialGaugeTemplatedSample : Page
{
    public RadialGaugeTemplatedSample()
    {
