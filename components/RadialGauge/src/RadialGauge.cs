...
/// You can choose to start here or from the <see cref="RadialGauge_ClassicBinding"/> or <see cref="RadialGauge_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class RadialGauge : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(RadialGauge), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is RadialGauge panel)
        {
